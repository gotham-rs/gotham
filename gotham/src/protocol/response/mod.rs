...
use protocol::header::{XContentTypeOptions, XFrameOptions, XRequestId, XXssProtection};
...
/// # use gotham::protocol::header::XRequestId;
...
/// # use hyper::{Response, StatusCode};
/// # use gotham::state::State;
/// # use gotham::protocol::response::create_permanent_redirect;
/// # use gotham::test::TestServer;
...
/// # use hyper::{Response, StatusCode};
/// # use gotham::state::State;
/// # use gotham::protocol::response::create_temporary_redirect;
/// # use gotham::test::TestServer;
/// # use hyper::header::Location;
/// fn handler(state: State) -> (State, Response) {
...
/// # use hyper::header::{ContentLength, ContentType};
/// # use gotham::state::State;
/// # use gotham::protocol::response::extend_response;
/// # use gotham::protocol::header::XRequestId;
/// # use gotham::test::TestServer;
/// #
/// static BODY: &'static [u8] = b"Hello, world!";
...
/// # use hyper::{Response, StatusCode};
/// # use gotham::state::State;
/// # use gotham::protocol::response::set_headers;
/// # use gotham::protocol::header::*;
/// # use gotham::test::TestServer;
/// #
/// fn handler(state: State) -> (State, Response) {
...
/// # use hyper::header::Location;
/// # use gotham::state::State;
/// # use gotham::protocol::response::set_redirect_headers;
/// # use gotham::protocol::header::*;
/// # use gotham::test::TestServer;
/// fn handler(state: State) -> (State, Response) {
